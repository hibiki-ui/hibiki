...
def main():
    ...
    increment_btn = Button(
        "Increment (+1)",
        style=ComponentStyle(width=px(150), height=px(35), margin_right=px(10)),
    ...
    decrement_btn = Button(
        "Decrement (-1)",
        style=ComponentStyle(width=px(150), height=px(35)),
    ...
    reset_btn = Button(
        "Reset",
        style=ComponentStyle(width=px(100), height=px(35), margin_top=px(10)),
    ...
    main_container = Container(
        children=[
            ...
            Container(
                children=[reset_btn],
                style=ComponentStyle(display=Display.FLEX, justify_content=JustifyContent.CENTER),
            ),
        ],
        style=ComponentStyle(
            padding=px(40),
    ...
    window = app_manager.create_window(title="Reactive Basics - Hibiki UI", width=500, height=350)
