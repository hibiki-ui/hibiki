...
import objc
from AppKit import (
    NSApplication, NSWindow, NSViewController, NSView, NSMenu, NSMenuItem, NSProcessInfo,
    NSWindowStyleMaskTitled, NSWindowStyleMaskClosable,
    NSWindowStyleMaskMiniaturizable, NSWindowStyleMaskResizable,
    NSBackingStoreBuffered, NSApplicationActivationPolicyRegular
)
from Foundation import NSRect, NSMakeRect, NSPoint, NSMakePoint, NSObject, NSBundle
